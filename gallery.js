    ...
    for (var i = 0; i < lists.length; i++) {
      ...
      for (var c = 0; c < list_elements.length; c++) {
        if (
          ...
          (list_elements[c].firstChild.tagName == "A" ||
            list_elements[c].firstChild.tagName == "IMG") &&
          (!list_elements[c].firstChild.firstChild ||
            (list_elements[c].firstChild.firstChild &&
              list_elements[c].firstChild.firstChild.tagName == "IMG"))
        ) {
          total_matches++;
        }
      }
